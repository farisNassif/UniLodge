...
\begin{lstlisting}[caption=Retrieving all Listings]
...
\paragraph{}
Since the component method outlined in \textbf{Listing 4.15} is \textit{subscribed} to this Service method, it waits for the call to the API to finish. When complete, the array of listings is returned to the component can be used in the relevant component to display all listings currently in the database.. 
