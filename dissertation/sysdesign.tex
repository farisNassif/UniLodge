...
The first page the user will see when visiting UniLodge will be the home page. Like every page, a navigation bar is present at the top. The navigation bar allows for quick access to the main pages of the application  The home page displays up to 8 listings to the user 
\begin{figure}[H]
